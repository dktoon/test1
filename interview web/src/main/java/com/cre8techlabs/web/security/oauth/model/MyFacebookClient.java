...
public class MyFacebookClient extends FacebookClient implements CustomOAuthExt {

	


	public MyFacebookClient(ObjectMapper mapper, String fbKey, String fbSecret) {
	    super(fbKey, fbSecret);
	    setName(OAuth.Facebook.toString());
	    this.mapper = mapper;
    }
	@Override
