...
public class MyGoogleClient extends Google2Client implements CustomOAuthExt {


	
    public MyGoogleClient(ObjectMapper mapper, String fbKey, String fbSecret) {
	    super(fbKey, fbSecret);
	    setName(OAuth.Google.toString());
	    this.mapper = mapper;
    }
	@Override
    ...
    protected void internalInit() {
        ...
        this.service = new com.cre8techlabs.web.security.oauth.model.MyProxyOAuth20ServiceImpl(new MyGoogleApi20(), new OAuthConfig(this.key, this.secret,
                this.callbackUrl,
    ...
    public String retrieveAuthorizationUrl(final WebContext context, String state) {
        ...
        if (requiresStateParameter()) {
            ...
            authorizationUrl = ((MyProxyOAuth20ServiceImpl) this.service).getAuthorizationUrl(jsonState);
        } else {
